...
whileend:                                         ; preds = %whilecond
  ...
  %ne = icmp ne i32 %a1, 0
  %eqtmp24 = zext i1 %ne to i32
  %and.result = alloca i32, align 4
  %and.left.cond = icmp eq i32 %eqtmp24, 0
...
and.right:                                        ; preds = %whileend
  %b1 = load i32, i32* %b, align 4
  %ne25 = icmp ne i32 %b1, 0
  %eqtmp26 = zext i1 %ne25 to i32
  %and.right.cond = icmp ne i32 %eqtmp26, 0
  %and.right.result = zext i1 %and.right.cond to i32
  store i32 %and.right.result, i32* %and.result, align 4
  br label %and.merge

and.merge:                                        ; preds = %and.right, %whileend
  %and.load = load i32, i32* %and.result, align 4
  %ifcond27 = icmp ne i32 %and.load, 0
  br i1 %ifcond27, label %then28, label %ifcont29

then28:                                           ; preds = %and.merge
  br label %ifcont29

ifcont29:                                         ; preds = %then28, %and.merge
